\centering
	...
	\node[item,fill=gray!80] (C2)
	  [below=3pt of B2] {Item A};
	\node[item,fill=gray!80] (D2)
	...
	\node[item,fill=gray!50] (F3)
	  [below=3pt of E3] {Item F};
	\node[item,fill=gray!50] (G3)
	...
	\node[item,fill=gray!50] (A5)
	  [right=0.5cm of A4]{Item B};
	\node[item,fill=gray!50] (B5)
	  [below=3pt of A5] {Item D};
	\node[item,fill=gray!50] (C5)
	  [below=3pt of B5] {Item F};
	\node[item,fill=gray!50] (D5)
